...
public class AccountsController {
    ...
    // throw new RuntimeException("Simulating an error for testing fallback
    // method");
    // // return ResponseEntity
    // // .status(HttpStatus.OK)
    // // .body(buildVersion);
    ...
    // LOG.debug("Fallback method called due to: {}", t.getMessage());
    // return ResponseEntity
    // .status(HttpStatus.OK)
    // .body("0.9.1");
    // }
    ...
    public ResponseEntity<String> getBuildInfo() {
        ...
        throw new RuntimeException("Simulating an error for testing fallback method");
        // return ResponseEntity
        // .status(HttpStatus.OK)
        // .body(buildVersion);
    }
